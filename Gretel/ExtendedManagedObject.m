...
/***
 ...
 http://stackoverflow.com/questions/4635556/how-can-i-send-a-nsdictionary-nsarray-with-the-gamekit
 
 **/
- (NSData *)toData {
    
    NSDictionary *tripDict = [self toDictionary];
    return [NSKeyedArchiver archivedDataWithRootObject:tripDict];
...
+ (ExtendedManagedObject*) createManagedObjectFromDictionary:(NSDictionary*)dict inContext:(NSManagedObjectContext*)context
{
    ...
    ExtendedManagedObject* newObject = (ExtendedManagedObject*)[NSEntityDescription insertNewObjectForEntityForName:class inManagedObjectContext:context];
